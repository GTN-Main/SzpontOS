...
static void handle_client(int cfd) {
    ...
    int body_len = snprintf(body, sizeof(body),
        ...
        ".card { background: #1e293b; border-radius: 12px; padding: 1.5rem; max-width: 600px; margin: 0 auto; box-shadow: 0 10px 25px rgba(0,0,0,0.5); border: 1px solid #334155; }\n"
        "h1 { color: #38bdf8; margin-top: 0; font-size: 1.75rem; }\n"
        ".badge { display: inline-block; background: #0284c7; color: white; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.85rem; font-weight: bold; }\n"
        ...
        "  <p style=\"margin-top: 1rem;\">Serving HTTP requests directly from Ring 3 userland with native Berkeley Sockets & TCP/IP stack.</p>\n"
        ...
        "  <p style=\"font-size: 0.8rem; color: #64748b; margin-top: 1.5rem;\">&copy; Copyright by Szpont Industries. All rights reserved.</p>\n"
        "</div>\n"
        "</body>\n"
        "</html>\n",
