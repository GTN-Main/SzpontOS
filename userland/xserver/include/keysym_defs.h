 ...
 *
 * Evdev Linux Scancode to X11 KeySym Mapping
 */

#ifndef SZPONT_KEYSYM_DEFS_H
#define SZPONT_KEYSYM_DEFS_H

#include <stdint.h>
#include <stdbool.h>

/* Standard X11 KeySym Constants */
...
/* Function to get keysym from evdev code and shift state */
uint32_t evdev_to_keysym(uint16_t code, bool shift, bool caps);

#endif /* SZPONT_KEYSYM_DEFS_H */
